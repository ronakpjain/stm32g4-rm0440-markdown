...
- Up to 128 Kbytes of flash memory (single bank).
...
- Capacity up to 128 Kbytes (read width of 64-bit)
...
| 6 | `0x0800 1000 - 0x0800 17FF` | `2 K` | `Page 2` |  |
| 7 | `Main memory(1)` |  |  |  |
| 8 | `0x0800 1800 - 0x0800 1FFF` | `2 K` | `Page 3` |  |
| 9 | `...` | `...` | `...` |  |
| 10 | `0x0801 F800 - 0x0801 FFFF` | `2 K` | `Page 63` |  |
...
1. From page 0 to page 15 for 32-Kbyte devices, from page 0 to page 31 for 64-Kbyte devices.
...
voltage scaling management. Table 29 shows the correspondence between wait states and CPU clock
frequency.
...
![Figure 9: Sequential 16-bit instructions execution (64-bit read data width)](../STM32G4_RM0440_figures/figure-0009.png)
...
The flash memory erase operation can be performed at page level or on the whole memory (mass erase).
Mass erase does not affect the Information block (system flash, OTP and option bytes).
...
If the flash memory contains a write-protected area (by WRP or PCROP), WRPERR is set and the mass
erase request is aborted.
...
If a flash memory write access concerns some data in the data cache, the write access modifies the
data in the flash memory and the data in the cache.

If an erase operation also concerns data in the data or instruction cache, you have to make sure
that these data are rewritten before they are accessed during code execution. If this cannot be done
safely, it is recommended to flush the caches by setting the DCRST and ICRST bits in the Flash
...
The organization of these bytes inside the information block is shown in Table 31.

The option bytes can be read from the memory locations listed in Table 31 or from the Option byte
registers:
...
**Table 31. Option byte organization(1)**
...
| ---: | --- | :---: | --- |
| 31 | Reserved | — | keep at 1 during option bytes programming. |
| 30 | `IRH_EN` | r | Internal reset holder on NRST pin |
| 29 | `NRST_MODE` | r | PG10 pad mode |
| 28 | `NRST_MODE` | r | ↳ |
...
| 22 | Reserved | — | keep at 1 during option bytes programming. |
| 21 | Reserved | — | ↳ |
| 20 | Reserved | — | ↳ |
...
| 15 | Reserved | — | keep at 1 during option bytes programming. |
...
| 11 | Reserved | — | keep at 1 during option bytes programming. |
...
**Bit 31 — Reserved:** keep at 1 during option bytes programming.
...
**Bits 22:20 — Reserved:** keep at 1 during option bytes programming.
...
**Bit 15 — Reserved:** keep at 1 during option bytes programming.
...
**Bit 11 — Reserved:** keep at 1 during option bytes programming.
...
| 15 | Reserved | — | ↳ |
| 14 | Reserved | — | ↳ |
| 13 | `PCROP1_STRT[13]` | r | PCROP area start offset |
| 12 | `PCROP1_STRT[12]` | r | ↳ |
| 11 | `PCROP1_STRT[11]` | r | ↳ |
| 10 | `PCROP1_STRT[10]` | r | ↳ |
| 9 | `PCROP1_STRT[9]` | r | ↳ |
...
**Bits 31:14 — Reserved:** keep at 1 during option bytes programming.
...
| 30 | Reserved | — | keep at 1 during option bytes programming. |
| 29 | Reserved | — | ↳ |
| 28 | Reserved | — | ↳ |
| 27 | Reserved | — | ↳ |
| 26 | Reserved | — | ↳ |
...
| 15 | Reserved | — | ↳ |
| 14 | Reserved | — | ↳ |
| 13 | `PCROP1_END[13]` | r | Bank 1 PCROP area end offset |
| 12 | `PCROP1_END[12]` | r | ↳ |
| 11 | `PCROP1_END[11]` | r | ↳ |
| 10 | `PCROP1_END[10]` | r | ↳ |
| 9 | `PCROP1_END[9]` | r | ↳ |
...
**Bits 30:14 — Reserved:** keep at 1 during option bytes programming.

**Bits 13:0 — `PCROP1_END[13:0]`:** Bank 1 PCROP area end offset
...
| 23 | Reserved | — | ↳ |
| 22 | Reserved | — | ↳ |
| 21 | `WRP1A_END[5]` | r | WRP first area “A” end offset |
| 20 | `WRP1A_END[4]` | r | ↳ |
| 19 | `WRP1A_END[3]` | r | ↳ |
| 18 | `WRP1A_END[2]` | r | ↳ |
| 17 | `WRP1A_END[1]` | r | ↳ |
...
| 7 | Reserved | — | ↳ |
| 6 | Reserved | — | ↳ |
| 5 | `WRP1A_STRT[5]` | r | WRP first area “A” start offset |
| 4 | `WRP1A_STRT[4]` | r | ↳ |
| 3 | `WRP1A_STRT[3]` | r | ↳ |
| 2 | `WRP1A_STRT[2]` | r | ↳ |
| 1 | `WRP1A_STRT[1]` | r | ↳ |
...
**Bits 31:22 — Reserved:** keep at 1 during option bytes programming.

**Bits 21:16 — `WRP1A_END[5:0]`:** WRP first area “A” end offset

WRP1A_END contains the last page of WRP first area.

**Bits 15:6 — Reserved:** keep at 1 during option bytes programming.
...
| 23 | Reserved | — | ↳ |
| 22 | Reserved | — | ↳ |
| 21 | `WRP1B_END[5]` | r | WRP second area “B” end offset |
| 20 | `WRP1B_END[4]` | r | ↳ |
| 19 | `WRP1B_END[3]` | r | ↳ |
| 18 | `WRP1B_END[2]` | r | ↳ |
| 17 | `WRP1B_END[1]` | r | ↳ |
...
| 7 | Reserved | — | ↳ |
| 6 | Reserved | — | ↳ |
| 5 | `WRP1B_STRT[5]` | r | WRP second area start offset |
| 4 | `WRP1B_STRT[4]` | r | ↳ |
| 3 | `WRP1B_STRT[3]` | r | ↳ |
| 2 | `WRP1B_STRT[2]` | r | ↳ |
| 1 | `WRP1B_STRT[1]` | r | ↳ |
...
**Bits 5:0 — `WRP1B_STRT[5:0]`:** WRP second area start offset
...
| 18 | Reserved | — | ↳ |
| 17 | Reserved | — | ↳ |
| 16 | `BOOT_LOCK` | r | used to force boot from user flash area |
| 15 | Reserved | — | keep at 1 during option bytes programming. |
| 14 | Reserved | — | ↳ |
| 13 | Reserved | — | ↳ |
| 12 | Reserved | — | ↳ |
...
| 8 | Reserved | — | ↳ |
| 7 | Reserved | — | ↳ |
| 6 | `SEC_SIZE1[6]` | r | Securable memory area size |
| 5 | `SEC_SIZE1[5]` | r | ↳ |
| 4 | `SEC_SIZE1[4]` | r | ↳ |
| 3 | `SEC_SIZE1[3]` | r | ↳ |
| 2 | `SEC_SIZE1[2]` | r | ↳ |
...
**Bits 31:17 — Reserved:** keep at 1 during option bytes programming.
...
**Bits 15:7 — Reserved:** keep at 1 during option bytes programming.
...
reflects the options states of the system. See Section: Modifying user options for more details.
...
pages can also be protected against unwanted write due to loss of program counter contexts. The
write-protection (WRP) granularity is one page (2 Kbytes). Apart of the flash memory can also be
protected against read and write from third parties (PCROP). The PCROP granularity is double word
(64-bit).
...
available. In user execution mode (boot FLASH mode), all operations are allowed on the main memory.
On the contrary, only read operations can be performed on the option bytes.
...
![Figure 10: Changing the read protection (RDP) level](../STM32G4_RM0440_figures/figure-0010.png)
...
| 5 | `level` |  |  |  |  |  |  |
| 6 | `Read` | `Write` | `Erase` | `Read` | `Write` | `Erase` |  |
| 7 | `1` | `Yes` | `No` | `No` | `Yes` | `No` | `No` |
| 8 | `System` |  |  |  |  |  |  |
| 9 | `memory (2)` |  |  |  |  |  |  |
| 10 | `2` | `Yes` | `No` | `No` | `N/A` | `N/A` | `N/A` |
| 11 | `1` | `Yes` | `Yes(3)` | `Yes` | `Yes` | `Yes(3)` | `Yes` |
| 12 | `Option bytes` |  |  |  |  |  |  |
| 13 | `2` | `Yes` | `No` | `No` | `N/A` | `N/A` | `N/A` |
| 14 | `1` | `Yes` | `Yes(4)` | `N/A` | `No` | `No` | `N/A` |
| 15 | `OTP` |  |  |  |  |  |  |
| 16 | `2` | `Yes` | `Yes(4)` | `N/A` | `N/A` | `N/A` | `N/A` |
| 17 | `1` | `Yes` | `Yes` | `N/A` | `No` | `No` | `No(5)` |
| 18 | `Backup` |  |  |  |  |  |  |
| 19 | `registers` |  |  |  |  |  |  |
| 20 | `2` | `Yes` | `Yes` | `N/A` | `N/A` | `N/A` | `N/A` |
| 21 | `1` | `Yes` | `Yes` | `N/A` | `No` | `No` | `No(6)` |
| 22 | `CCM SRAM` |  |  |  |  |  |  |
| 23 | `2` | `Yes` | `Yes` | `N/A` | `N/A` | `N/A` | `N/A` |
...
flash address. These offsets are defined in the PCROP address registers Flash PCROP1 Start address
register (FLASH_PCROP1SR), Flash PCROP1 End address register (FLASH_PCROP1ER).
...
For example, to protect by PCROP from the address 0x0800 2F80 (included) to the address 0x0801 0004
(included):
...
protection level). In this case, PCROP1_STRT and PCROP1_END are also not erased.
...
The user area can be protected against unwanted write operations. It allows either to specify:
...
occurs. The main purpose of the securable memory area is to protect a specific part of the memory
against undesired access. This allows implementing software security services such as secure key
storage or safe boot. Securable memory area is located in the
main memory. It is dedicated to executing trusted code. When not secured, the securable memory
behaves like the remainder of the main memory. When secured (the SEC_PROT1 bit of the FLASH_CR
register set), any attempt to program or erase in a secure memory area generates a write protection
error (WRPERR flag is set) and any attempt to read from it generates a read error (RDERR flag is
set).

The size of the securable memory area is defined by the SEC_SIZE1[6:0] bitfield of the FLASH_SEC
...
![Figure 11: Example of disabling core debug access](../STM32G4_RM0440_figures/figure-0011.png)
...
| 21 | Reserved | — | kept at reset v. |
| 20 | Reserved | — | ↳ |
| 19 | Reserved | — | ↳ |
| 18 | `ADDR_ECC` | r | ECC fail address |
| 17 | `ADDR_ECC` | r | ↳ |
| 16 | `ADDR_ECC` | r | ↳ |
| 15 | `ADDR_ECC` | r | ↳ |
| 14 | `ADDR_ECC` | r | ↳ |
...
**Bits 21:19 — Reserved:** kept at reset v.
...
Together with the BOOT0 pin, this bit selects boot mode from the flash main memory, SRAM1 or the
System memory. Refer to [Section 2.6](chapter-02.md#26-boot-configuration).
...
| 16 | Reserved | — | ↳ |
| 15 | Reserved | — | ↳ |
| 14 | `PCROP1_END[14]` | rw | PCROP area end offset |
| 13 | `PCROP1_END[13]` | rw | ↳ |
| 12 | `PCROP1_END[12]` | rw | ↳ |
| 11 | `PCROP1_END[11]` | rw | ↳ |
| 10 | `PCROP1_END[10]` | rw | ↳ |
...
| 23 | Reserved | — | ↳ |
| 22 | Reserved | — | ↳ |
| 21 | `WRP1A_END[5]` | rw | WRP first area “A” end offset |
| 20 | `WRP1A_END[4]` | rw | ↳ |
| 19 | `WRP1A_END[3]` | rw | ↳ |
| 18 | `WRP1A_END[2]` | rw | ↳ |
| 17 | `WRP1A_END[1]` | rw | ↳ |
...
| 7 | Reserved | — | ↳ |
| 6 | Reserved | — | ↳ |
| 5 | `WRP1A_STRT[5]` | rw | WRP first area “A” start offset |
| 4 | `WRP1A_STRT[4]` | rw | ↳ |
| 3 | `WRP1A_STRT[3]` | rw | ↳ |
| 2 | `WRP1A_STRT[2]` | rw | ↳ |
| 1 | `WRP1A_STRT[1]` | rw | ↳ |
...
**Bits 15:6 — Reserved:** kept at reset value.
...
| 23 | Reserved | — | ↳ |
| 22 | Reserved | — | ↳ |
| 21 | `WRP1B_END[5]` | rw | WRP second area “B” end offset |
| 20 | `WRP1B_END[4]` | rw | ↳ |
| 19 | `WRP1B_END[3]` | rw | ↳ |
| 18 | `WRP1B_END[2]` | rw | ↳ |
| 17 | `WRP1B_END[1]` | rw | ↳ |
...
| 7 | Reserved | — | ↳ |
| 6 | Reserved | — | ↳ |
| 5 | `WRP1B_STRT[5]` | rw | WRP second area “B” start offset |
| 4 | `WRP1B_STRT[4]` | rw | ↳ |
| 3 | `WRP1B_STRT[3]` | rw | ↳ |
| 2 | `WRP1B_STRT[2]` | rw | ↳ |
| 1 | `WRP1B_STRT[1]` | rw | ↳ |
...
| 8 | Reserved | — | ↳ |
| 7 | Reserved | — | ↳ |
| 6 | `SEC_SIZE1[6]` | rw | sets the number of pages used in the securable area. |
| 5 | `SEC_SIZE1[5]` | rw | ↳ |
| 4 | `SEC_SIZE1[4]` | rw | ↳ |
| 3 | `SEC_SIZE1[3]` | rw | ↳ |
| 2 | `SEC_SIZE1[2]` | rw | ↳ |
